# Contributing to Ralph-Antigravity 🤝

Thank you for your interest in improving Ralph-Antigravity! As an autonomous development loop, we have specific standards for how code should be contributed.
...
## 2. The Ralph Quality Bar
Every contribution must be "Ralph-Ready." This means:
...
4. Run `python src/ralph_controller.py next` to verify task selection and branching logic.
